...
u8 MGPIO_u8SetPinDirection(u8 Copy_u8Port , u8 Copy_u8Pin , u8 Copy_u8Mode)
{
	...
	case GPIOA :
		...
		{
			Local_u8ErrorState = 1;		/* Wrong Choice In Copy_u8Pin */
		}
		break;
	...
	default :   Local_u8ErrorState = 1; break;        /* Wrong Choice In Copy_u8Pin */
	}
...
u8 MGPIO_u8SetPinValue(u8 Copy_u8Port , u8 Copy_u8Pin , u8 Copy_u8Value)
{
	...
	case GPIOA :
		...
		{
			Local_u8ErrorState = 1;		/* Wrong Choice In Copy_u8Value */
		}
		break;
	...
	default :  Local_u8ErrorState = 1; break;		    /* Wrong Choice In Copy_u8Port */
	}
	return Local_u8ErrorState;							/* Return Error State          */
}
/********************************************************************************************/
...
u8 MGPIO_u8GetPinValue(u8 Copy_u8Port , u8 Copy_u8Pin , u8* Copy_pu8Value)
{
	...
	{
		Local_u8ErrorState = 1;													/* Copy_pu8Value = NULL and pin > 15 */
	}
...
u8 MGPIO_u8SetHalfPortValue(u8 Copy_u8Port , u8 Copy_u8HalfPort , u8 Copy_u8Value)
{
	...
	if(Copy_u8Port == GPIOA)
	{
		...
		default	:  Local_u8ErrorState = 1;   break;		/* Wrong Choice In Copy_u8HalfPort   */
		}
	}
	...
	{
		Local_u8ErrorState = 1;							/* Wrong Choice In Copy_u8Port        */
	}
	return Local_u8ErrorState;							   /* Return Error State                  */
}
/********************************************************************************************/
