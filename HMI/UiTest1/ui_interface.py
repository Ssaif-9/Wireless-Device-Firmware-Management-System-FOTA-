...
################################################################################
## Form generated from reading UI file 'interfacemduKRX.ui'
##
...
"}")
        ...
        icon17 = QIcon()
        icon17.addFile(u":/Icons/Icons/clock.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/Icons/Icons/calendar.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/Icons/Icons/bluetooth.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/Icons/Icons/camera.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/Icons/Icons/aperture.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/Icons/Icons/power.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.CriticalModeNotification = QCustomSlideMenu(self.MainBodyContainer)
        ...
        self.verticalLayout_10.addWidget(self.CriticalModeNotification)

        self.DownloadingNotification = QCustomSlideMenu(self.MainBodyContainer)
        ...
        self.verticalLayout_10.addWidget(self.DownloadingNotification)


        self.horizontalLayout.addWidget(self.MainBodyContainer)
        
        self.DiagnosticTextBox.setStyleSheet("color:rgb(0,0,0); background-color:rgb(255,255,255); font-size:30px;")
